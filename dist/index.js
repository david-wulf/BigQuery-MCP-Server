...
server.registerTool("gsc_quick_wins", {
    description: "Find keywords from GSC bulk export data at positions 4 to 15 with high impressions. These are striking distance keywords that could be pushed to page one. Sorted by traffic opportunity." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
...
server.registerTool("gsc_ctr_opportunities", {
    description: "Find pages with high impressions but CTR significantly below the expected benchmark for their ranking position. These are title and meta description optimisation candidates." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
        days: zod_1.z.number().default(28).describe("Number of days to analyse"),
...
server.registerTool("gsc_site_snapshot", {
    description: "Get a quick overview of how the site is performing. Returns total clicks, impressions, CTR, position, unique pages and queries with a comparison to the prior period." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
...
server.registerTool("gsc_cannibalisation", {
    description: "Find keywords where multiple pages from your site compete against each other. Shows which pages rank for the same query and their respective positions." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
        days: zod_1.z.number().default(28).describe("Number of days to analyse"),
...
server.registerTool("gsc_topic_cluster", {
    description: "See how a group of pages performs as a whole. Aggregates clicks, impressions, CTR, and position for all pages matching a URL path pattern, plus top pages and queries." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
...
server.registerTool("gsc_ctr_benchmark", {
    description: "Compare your actual CTR per page against industry benchmarks by position. Flags pages significantly underperforming for their ranking position with verdicts." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
        days: zod_1.z.number().default(28).describe("Number of days to analyse"),
...
server.registerTool("gsc_seasonal", {
    description: "Year-over-year seasonal traffic analysis. Shows monthly clicks, impressions, CTR, and position with YoY comparison. Requires 12+ months of BigQuery data. Impossible with the 16-month rolling GSC API." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
...
server.registerTool("gsc_device_split", {
    description: "Find queries where mobile and desktop rank different pages from your site. This device cannibalisation is invisible in the GSC UI and impossible to detect via the API's 3-dimension limit." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
        days: zod_1.z.number().default(28).describe("Number of days to analyse"),
...
server.registerTool("gsc_intent_breakdown", {
    description: "Classify all your ranking queries by search intent (informational, transactional, commercial, navigational) using regex pattern matching at scale. Shows clicks, impressions, and CTR by intent category." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
        days: zod_1.z.number().default(28).describe("Number of days to analyse"),
        dataset: zod_1.z.string().optional().describe("BigQuery dataset containing GSC data"),
    },
...
server.registerTool("gsc_new_keywords", {
    description: "Discover queries that appeared in your recent data but were not present in the baseline period. Useful for spotting new ranking opportunities, trending topics, or the impact of recently published content." + guardrails_js_1.GUARDRAIL_SUFFIX + guardrails_js_1.VISUAL_SUFFIX + guardrails_js_1.POSITION_CAVEAT,
    inputSchema: {
